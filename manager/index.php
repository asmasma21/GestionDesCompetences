                        ...
                        switch($_GET['module']){
                            case "project":
                                if(isset($_GET['option'])){
                                    switch ($_GET['option']){
                                        case "add":
                                            echo '<div class="breadcrumb_divider"></div> <a href="javascript:void(0);" class="current">Cr&eacute;er Nouveau Projet</a>';
                                            break;
                                        case "list":
                                            echo '<div class="breadcrumb_divider"></div> <a href="javascript:void(0);" class="current">Voir Projets</a>';
                                            break;
                                        case "edit":
                                            echo '<div class="breadcrumb_divider"></div> <a href="javascript:void(0);" class="current">Edit Projets</a>';
                                            break;
                                        case "delete":
                                            echo '<div class="breadcrumb_divider"></div> <a href="javascript:void(0);" class="current">Delete Projets</a>';
                                            break;
                                        default :
                                            break;
                                    }
                            ...
                            default :
                                ...
                                if(isset($_GET['option'])){
                                    switch ($_GET['option']){
                                        case "add":
                                            echo '<div class="breadcrumb_divider"></div> <a href="javascript:void(0);" class="current">Affecter Collaborateur</a>';
                                            break;
                                        case "list":
                                            echo '<div class="breadcrumb_divider"></div> <a href="javascript:void(0);" class="current">Liste des Collaborateurs</a>';
                                            break;
                                        case "edit":
                                            echo '<div class="breadcrumb_divider"></div> <a href="javascript:void(0);" class="current">Edit Collaborateur</a>';
                                            break;
